...
| <a name="input_fortigate_custom_config_file_path"></a> [fortigate\_custom\_config\_file\_path](#input\_fortigate\_custom\_config\_file\_path) | the file path for custom fortios configrations | `string` | n/a | yes |
